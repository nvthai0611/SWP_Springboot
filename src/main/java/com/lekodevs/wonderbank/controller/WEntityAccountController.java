...
public class WEntityAccountController {
	...
	public ResponseEntity<Object> balance() {
		return EntityResponse.generateResponse("Balance", HttpStatus.OK, entityAccountService.getAccountBalanceList());
	}
	...
	@PostMapping("/pay")
	@ResponseBody
	public ResponseEntity<Object> pay(@RequestBody PayRequestDTO requestDTO) {
		return EntityResponse.generateResponse("Deposit", HttpStatus.OK, entityAccountService.pay(requestDTO));
	}
}
